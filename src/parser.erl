...
-file("/Users/ivanivanov/.asdf/installs/erlang/27.0.1/lib/parsetools-2.6/include/yeccpre.hrl", 0).
%%
%% %CopyrightBegin%
%%
...
yeccpars2_7(_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 ...
 yeccgoto_mult_arithmetic_op(hd(Ss), Cat, Ss, NewStack, T, Ts, Tzr).

-dialyzer({nowarn_function, yeccpars2_8/7}).
-compile({nowarn_unused_function,  yeccpars2_8/7}).
yeccpars2_8(_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 NewStack = yeccpars2_8_(Stack),
 yeccgoto_dual_arithmetic_op(hd(Ss), Cat, Ss, NewStack, T, Ts, Tzr).
...
-dialyzer({nowarn_function, yeccgoto_dual_arithmetic_op/7}).
-compile({nowarn_unused_function,  yeccgoto_dual_arithmetic_op/7}).
yeccgoto_dual_arithmetic_op(2, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_0(6, Cat, Ss, Stack, T, Ts, Tzr);
yeccgoto_dual_arithmetic_op(12, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_0(6, Cat, Ss, Stack, T, Ts, Tzr);
yeccgoto_dual_arithmetic_op(13, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_0(6, Cat, Ss, Stack, T, Ts, Tzr);
yeccgoto_dual_arithmetic_op(14, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_0(6, Cat, Ss, Stack, T, Ts, Tzr).
...
-dialyzer({nowarn_function, yeccgoto_mult_arithmetic_op/7}).
-compile({nowarn_unused_function,  yeccgoto_mult_arithmetic_op/7}).
yeccgoto_mult_arithmetic_op(2, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_0(5, Cat, Ss, Stack, T, Ts, Tzr);
yeccgoto_mult_arithmetic_op(12, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_0(5, Cat, Ss, Stack, T, Ts, Tzr);
yeccgoto_mult_arithmetic_op(13, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_0(5, Cat, Ss, Stack, T, Ts, Tzr);
yeccgoto_mult_arithmetic_op(14, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_0(5, Cat, Ss, Stack, T, Ts, Tzr).
