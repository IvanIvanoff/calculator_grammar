-file("/Users/ivanivanov/.asdf/installs/erlang/27.0.1/lib/parsetools-2.6/include/leexinc.hrl", 0).
...
-file("/Users/ivanivanov/.asdf/installs/erlang/27.0.1/lib/parsetools-2.6/include/leexinc.hrl", 14).
...
yystate(9, [10|Ics], Line, _, Tlen, _, _) ->
    yystate(9, Ics, Line+1, 1, Tlen+1, 7, Tlen);
yystate(9, Ics, Line, Col, Tlen, _, _) ->
    {7,Tlen,Ics,Line,Col,9};
yystate(8, [61|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(8, [43|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(4, [46|Ics], Line, Col, Tlen, _, _) ->
    yystate(2, Ics, Line, Col, Tlen+1, 5, Tlen);
yystate(4, [C|Ics], Line, Col, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(4, Ics, Line, Col, Tlen+1, 5, Tlen);
...
yyaction_6(TokenChars, TokenLine, TokenCol) ->
    TokenLoc={TokenLine,TokenCol},
     { token, { int, TokenLoc, list_to_float (TokenChars) } } .

-compile({inline,yyaction_7/0}).
-file("src/lexer.xrl", 14).
yyaction_7() ->
     skip_token .
-file("/Users/ivanivanov/.asdf/installs/erlang/27.0.1/lib/parsetools-2.6/include/leexinc.hrl", 344).
